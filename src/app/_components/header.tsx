          ...
          <div className="flex items-center gap-2">
            {session?.user ? (
              ...
              <div className="flex items-center space-x-2 sm:space-x-3">
                <Link
                  href="/signin"
                  className="text-gray-700 hover:text-gray-900 font-semibold py-2 px-3 sm:px-4 text-sm sm:text-base rounded-full hover:bg-gray-100 transition"
                >
                  Sign In
                </Link>
                <Link
                  href="/join"
                  className="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-3 sm:px-5 text-sm sm:text-base rounded-full transition"
                >
                  Join Us
                </Link>
              </div>
