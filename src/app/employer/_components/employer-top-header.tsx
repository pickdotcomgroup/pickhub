...
import { Search, Bell, Settings, LogOut, User, Plus } from "lucide-react";
...
export default function EmployerTopHeader({
            ...
            {isDropdownOpen && (
              <div className="absolute right-0 mt-2 w-64 bg-white rounded-xl shadow-lg border border-gray-200 py-2 z-50">
                ...
                <div className="px-4 py-3 border-b border-gray-100">
                  ...
                  <p className="text-xs text-gray-400 mt-2">{companyName}</p>
                </div>
